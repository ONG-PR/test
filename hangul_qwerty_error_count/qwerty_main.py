...
#f=open("D:/Google 드라이브/Documents/__CODES/corpus_pre_process/utf8_p_short.txt", 'r', encoding='utf-8')
t01=f.read()
f.close()
f2=open("C:/Users/USER/Documents/__CODES/말뭉치파일/syl-1.txt", 'r')
#f2=open("D:/Google 드라이브/Documents/__CODES/말뭉치파일/syl-1.txt", 'r')
t02=f2.read()
f2.close()
...
while(chk==0):
	...
	print('')
	if wc<=2: chk=1
	else: print("2어절 이하의 검색어를 입력해주세요\n")
...
for w_i in range( len(word_l) ):    # 어절별로 LOOP 돌림 _ word_l[w_i] 교정
