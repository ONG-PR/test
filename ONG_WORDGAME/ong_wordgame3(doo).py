...
def define_end(word):
    ...
    jungsung = [0'ㅏ', 1'ㅐ', 2'ㅑ', 3'ㅒ', 4'ㅓ', 5'ㅔ', 6'ㅕ', 7'ㅖ', 8'ㅗ', 9'ㅘ', 10'ㅙ', 11'ㅚ', 12'ㅛ', 13'ㅜ', 14'ㅝ', 15'ㅞ',
                16'ㅟ', 17'ㅠ', 19'ㅡ', 20'ㅢ', 21'ㅣ']
    '''
...
def find_next_word_for(data):
    ...
    while True:
        ...
        if check_user_word(user_word, prev_word, end):    # 끝말잇기 조건에 부합하지 확인

            prev_word.append(user_word)    # 입력받은 단어가 끝말잇기 조건에 부합 & 중복되지 않으면 list에 저장
            end = define_end(user_word)    # 입력받은 단어의 마지막 글자 저장
